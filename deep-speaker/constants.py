...
SAMPLE_RATE = 24000  # not higher than that otherwise we may have errors when computing the fbanks.
...
#NUM_FBANKS = 64
NUM_FRAMES = 240  # 1 second ~ 100 frames with default params winlen=0.025,winstep=0.01
NUM_FBANKS = 128
